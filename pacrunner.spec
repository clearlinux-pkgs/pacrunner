...
Source0  : https://www.kernel.org/pub/linux/network/connman/pacrunner-0.18.tar.xz
...
%prep
%setup -q -n pacrunner-0.18
cd %{_builddir}/pacrunner-0.18
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607388268
...
cp %{_builddir}/pacrunner-0.18/COPYING %{buildroot}/usr/share/package-licenses/pacrunner/a7a897a4bde987e597c04f16a9c28f6d3f57916d
cp %{_builddir}/pacrunner-0.18/COPYING.LIB %{buildroot}/usr/share/package-licenses/pacrunner/32c7c5556c56cdbb2d507e27d28d081595a35a9b
%make_install
